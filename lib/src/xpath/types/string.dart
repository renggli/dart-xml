...
class _XPathStringType extends XPathType<String> {
  ...
  String cast(Object value) => switch (value) {
    ...
    XPathDuration() => xsDuration.castToString(value),
    Duration() => xsDayTimeDuration.castToString(xsDayTimeDuration.cast(value)),
    XPathDateTimeStamp() => xsDateTimeStamp.castToString(value),
    XPathDateTime() => xsDateTime.castToString(value),
    XPathDate() => xsDate.castToString(value),
    XPathTime() => xsTime.castToString(value),
    XPathYearMonth() => xsYearMonth.castToString(value),
    XPathYear() => xsYear.castToString(value),
    XPathMonthDay() => xsMonthDay.castToString(value),
    XPathMonth() => xsMonth.castToString(value),
    XPathDay() => xsDay.castToString(value),
    DateTime() => xsDateTime.castToString(xsDateTime.cast(value)),
