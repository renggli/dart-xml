...
const standardFunctionDefinitions = <XPathFunctionDefinition>[
  ...
  number.fnNumber,
  sequence.fnFormatInteger,
  sequence.fnFormatNumber,
  math.mathPi,
  math.mathExp,
  math.mathExp10,
  math.mathLog,
  ...
  constructors.xsByteConstructor,
  constructors.xsIntConstructor,
  constructors.xsLongConstructor,
  constructors.xsNegativeIntegerConstructor,
  constructors.xsNonNegativeIntegerConstructor,
  constructors.xsNonPositiveIntegerConstructor,
  constructors.xsPositiveIntegerConstructor,
  constructors.xsShortConstructor,
  constructors.xsUnsignedByteConstructor,
  constructors.xsUnsignedIntConstructor,
  constructors.xsUnsignedLongConstructor,
  constructors.xsUnsignedShortConstructor,
  constructors.xsDateConstructor,
  constructors.xsDateTimeConstructor,
  constructors.xsDateTimeStampConstructor,
  constructors.xsGDayConstructor,
  constructors.xsGMonthConstructor,
  constructors.xsGMonthDayConstructor,
