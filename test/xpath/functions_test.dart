...
void main() {
  group('accessor.dart', () {
    ...
    test('fn:data', () {
      ...
      expect(
        fnData(context, XPathSequence.single([1, 2, 3])),
  ...
  group('number.dart', () {
    ...
    test('fn:random-number-generator', () {
      ...
      final next = (result['next'] as Function)(context);
      ...
      final permuted = (result['permute'] as Function)(
        context,
        const XPathSequence([1, 2, 3]),
      );
  ...
  group('higher_order.dart', () {
    ...
    test('fn:function-lookup', () {
      expect(
        () =>
            fnFunctionLookup(context, XPathSequence.empty, XPathSequence.empty),
        throwsA(isA<UnimplementedError>()),
      );
    });
  ...
  group('array.dart', () {
    ...
    test('array:join', () {
      expect(
        arrayJoin(context, XPathSequence.single([1, 2])).first,
        orderedEquals([1, 2]),
      );
      expect(
        arrayJoin(
  ...
  group('date_time.dart', () {
    ...
    test('missing functions stubs', () {
      ...
      expect(
        () =>
            fnFormatDateTime(context, XPathSequence.empty, XPathSequence.empty),
        throwsA(isA<UnimplementedError>()),
      );
      expect(
